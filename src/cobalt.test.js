cobalt.test = (function(self) {
	 ...
	 */
	cobaltTest.prototype.escape = function(s) {
	    var n = s;
	    n = n.replace(/&/g, "&amp;");
	    n = n.replace(/</g, "&lt;");
	    n = n.replace(/>/g, "&gt;");
	...
	cobaltTest.prototype.diffString = function( o, n ) {
	  o = o.replace(/\s+$/, '');
	  n = n.replace(/\s+$/, '');
	...
	cobaltTest.prototype.randomColor = function() {
	    return "rgb(" + (Math.random() * 100) + "%, " + 
	                    (Math.random() * 100) + "%, " + 
	                    (Math.random() * 100) + "%)";
	}

	cobaltTest.prototype.diffString2 = function( o, n ) {
		o = o.replace(/\s+$/, '');
		n = n.replace(/\s+$/, '');
	...
	cobaltTest.prototype.diff = function( o, n ) {
		var ns = new Object();
		var os = new Object();
	...
	cobaltTest.prototype.isArray = function( o ) {
	...
	cobaltTest.prototype.getPrototypeName = function( o ) {
		return Object.prototype.toString.call( o );
	}

	cobaltTest.prototype.isString = function( o ) {
		if ( typeof o === 'string' ) {
			return true;
		}
		return false;
	...
	cobaltTest.prototype.run = function() {
		this.errors = [];
		this.success = 0;
		for ( var i in this ) {
			if ( i.substr(0,4)=='test' ) {
				...
				try {
					...
					this.errors.push('test failed: uncaught exception at ' + this.currentTest + ': ' + e.message + '(' + e.code + ')' );
					this.write( this.errors[ this.errors.length - 1 ] );
				}
			}
		}
	...
	cobaltTest.prototype.write = function( message ) {
